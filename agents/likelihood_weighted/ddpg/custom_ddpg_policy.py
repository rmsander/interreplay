...
DEFAULT_CONFIG = with_common_config({
    ...
    "target_network_update_freq": TARGET_UPDATE_FREQ["DDPG"],
...
############################## BIER ############################################
def get_policy_class_likelihood(config):
    if config["framework"] == "torch":
        from agents.likelihood_weighted.ddpg.likelihood_weighted_ddpg_policy \
            import DDPGTorchPolicyLikelihoodWeighted
        return DDPGTorchPolicyLikelihoodWeighted
    else:
        return DDPGTFPolicy
############################## BIER ############################################
...
DDPGTrainerLikelihoodWeighting = GenericOffPolicyTrainer.with_updates(
    name="DDPG",
